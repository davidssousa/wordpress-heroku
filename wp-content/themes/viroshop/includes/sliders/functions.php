...
//	Youtube
	function youtube_embed() {
		...
		if ( isset($meta['youtube_autoplay']) && $meta['youtube_autoplay'] == 'true' ) { $autoplay = 1; } else { $autoplay = 0; }
		if ( isset($meta['youtube_autoplay']) && $meta['youtube_autoplay'] == 'true' ) { $controls = 1; } else { $controls = 0; }
		if ( isset($meta['youtube_autoplay']) && $meta['youtube_autoplay'] == 'true' ) { $showinfo = 1; } else { $showinfo = 0; }
		if ( isset($meta['youtube_autoplay']) && $meta['youtube_autoplay'] == 'true' ) { $autohide = 1; } else { $autohide = 0; }
